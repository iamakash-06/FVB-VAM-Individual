...
data = pd.read_csv('./Data_csv/circle_coordinates_39.csv')
...
plt.legend(handles=[plt.Line2D([0], [0], marker='o', color='w', markerfacecolor=color, markersize=10, label=label) for color, label in zip(colors, labels)])
st.pyplot(plt.gcf())
# But the ./Data_csv/circle_coordinates_40.csv should be n-1 of the experiment number, that is the above code is for experiment_41